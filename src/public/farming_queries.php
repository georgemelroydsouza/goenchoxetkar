<?php
$pageSubTitle = 'Farming Queries';
$menuActive = 'farming_queries';
require("structure/header.php");
?>

  <!-- ##### Breadcrumb Area Start ##### -->
  <div class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url('img/bg-img/banner/farmingqueries_banner.webp');">
    ...
    <div class="container">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Farming Queries</li>
        </ol>
      </nav>
    </div>
  </div>
