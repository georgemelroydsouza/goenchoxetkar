          ...
          <div class="col-12">
            <div class="top-header-content d-flex align-items-center justify-content-between">
              ...
              <div class="top-header-meta text-right">
                ...
                <a href="#" data-toggle="tooltip" data-placement="bottom" title="+91 9130882782 / +91 9850482858"><i class="fa fa-phone" aria-hidden="true"></i> <span>Call Us: +91 9130882782 / +91 9850482858</span></a>&nbsp;&nbsp;&nbsp;
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="classy-menu">
              ...
              <div class="classynav">
                <ul>
				  ...
				  <li <?=($menuActive=='farming_queries') ? 'class="active"' : ''?>><a href="/farming_queries.php">Bookings</a></li>
