...
?>
  ...
  <div class="hero-area">
    <div class="welcome-slides owl-carousel">
      ...
      <!-- Single Welcome Slides -->
      <div class="single-welcome-slides bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/banner/home_banner02.webp);">
        <div class="container h-100">
          <div class="row h-100 align-items-center">
            <div class="col-12 col-lg-10">
              <div class="welcome-content">
      ...
      <div class="row">
        <div class="col-12">
          <div class="benefits-thumbnail mb-50">
            <img src="img/bg-img/home_goenchoxetkar.webp" alt="">
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="section-heading text-center">
            ...
            <h2><span>Goencho Xetkar</span> Services</h2>
